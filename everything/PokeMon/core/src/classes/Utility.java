...
//            add(Fluctuating.get(99));
    ...
    public static HashMap<Integer, LinkedHashMap<Integer, Move>> Learnsets = new HashMap<Integer, LinkedHashMap<Integer, Move>>(){
        {
            try{
                BufferedReader learnSets = new BufferedReader(new FileReader("core/assets/data/csv/LearnSet.csv"));
                String line1;
                String line2;
    ...
    public static HashMap<Integer, Move> movelist = new HashMap<Integer, Move>(){
        {
                ...
                */
            try{
                BufferedReader move = new BufferedReader(new FileReader("core/assets/data/csv/movelist.csv"));
                String line;
    ...
    public static HashMap<String, String[]> baseInfo = new HashMap<String, String[]>(){
        {
            try{
                BufferedReader move = new BufferedReader(new FileReader("core/assets/data/csv/Pokemon.csv"));
                String line;
...
//                    System.out.println(data.toString());
    ...
    public static HashMap<String, String[]> OpponentParties = new HashMap<String, String[]>(){
        {
            try {
                BufferedReader poke = new BufferedReader(new FileReader("core/assets/data/csv/OpponentTeams.csv"));
                String p1;
                while ((p1 = poke.readLine()) != null){
//                    System.out.println(p1);
                    String trainer = p1.substring(0,p1.indexOf(",")).trim();
                    p1 = p1.substring(p1.indexOf(",") + 1);
                    String party[] = p1.split(",");
                    for(int i = 0; i< party.length; i++)
                        party[i] = party[i].trim();
                    put(trainer, party);
                }
            }catch(Exception e){
